...
import threadsSvg from '~/assets/threads.svg?raw'
...
const socialLinks = [
  ...
  { href: 'https://www.threads.com/@enricodeleo', label: 'Threads', icon: threadsSvg, hoverColor: 'hover:text-gray-900 dark:hover:text-[#F8FAFC]' },
