...
// Head configuration
const pageTitle = 'Cookie Policy - Enrico Deleo'
const pageDescription = 'Informazioni sull\'utilizzo dei cookie e delle tecnologie di tracciamento su questo sito.'
